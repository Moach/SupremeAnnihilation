...
function widget:MousePress(mx, my, mb)
	...
	WG.WaypointDrag = true -- mark for all to read that waypoint dragging is active, thus avoid conflicts (that means YOU, unit_smart_select!)
...
function widget:MouseRelease(mx, my, mb)
	...
	WG.WaypointDrag = nil -- ok, we're done, let it be know that life can proceed as normal
	return false
end
