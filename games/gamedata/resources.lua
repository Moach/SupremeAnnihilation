local resources = {
      graphics = {
         ...
         groundfx = {
            groundflash = 'PD/null.tga', --'default/groundflash.tga', -- this might fix the fugly square explosions trouble... by brute force, if nothing else will do
            groundring  = 'PD/null.tga', --'default/groundring.tga',
            seismic     = 'PD/null.tga', --'default/circles.tga',
         },
         projectiletextures = {
