...
- Use mousewheel (+hold ÿÿÿSHIFTÿÿÿÿ for speedup)\
 to scroll through the chatlog.",
	...
	order = {
		...
		["Attack AoE"] = 72,
		["Attack and Move Notification"] = 47,
		["Attack no ally"] = 23,
		["Auto Cloak Popups"] = 0,
		...
		["Factory KickStart"] = 0,
		["Factory hold position"] = 58,
		FactoryGuard = 0,
		["FactoryQ Manager"] = 10,
		["Fancy Selected Units"] = 14,
		["First launch setup"] = 0,
		["Frontline Repairs"] = 67,
		...
		ReclaimInfo = 0,
		["Red Build/Order Menu"] = 49,
		["Red Console (Battle and autohosts)"] = 60,
		["Red Console (In-game chat only)"] = 52,
		["Red Minimap"] = 15,
		["Red Tooltip"] = 12,
		Red_Drawing = 87,
		Red_UI_Framework = 6,
		...
		["Set fighters on Fly mode"] = 76,
		["Set target default"] = 3,
