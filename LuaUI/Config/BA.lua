...
- Use mousewheel (+hold ÿÿÿSHIFTÿÿÿÿ for speedup)\
 to scroll through the chatlog.",
	...
	order = {
		...
		["Context Build"] = 85,
		Cursors = 81,
		CustomFormations2 = 104,
		["DGun Stall Assist"] = 72,
		["DGun no ally"] = 50,
		["DGun no ground enemies"] = 46,
		["Darken map"] = 0,
		["Default Group Recall Fix"] = 103,
		["Defense Range"] = 0,
		...
		["MexUpg Helper"] = 0,
		MoreSounds = 70,
		["Mouse Buildspacing"] = 100,
		["Mouse FX"] = 88,
		["Mouse Reclaim/Patrol"] = 101,
		["Mouse to Mexes"] = 0,
		["Move Window Position"] = 0,
		["Music Player"] = 18,
		NoDuplicateOrders = 73,
		...
		["Set fighters on Fly mode"] = 97,
		["Set target default"] = 2,
		["Shadow Quality Manager"] = 0,
		["Share Tracker"] = 0,
		["Show Builder Queue"] = 98,
		["Show Orders"] = 36,
		["Smart Area Reclaim"] = 69,
		SmartNanos = 59,
		SmartSelect = 40,
		SmoothScroll = 0,
		Snow = 0,
		["Specific Unit Loader"] = 63,
