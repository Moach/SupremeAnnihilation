...
- Use mousewheel (+hold ÿÿÿSHIFTÿÿÿÿ for speedup)\
 to scroll through the chatlog.",
	...
	order = {
		...
		["Attack AoE"] = 86,
		["Attack and Move Notification"] = 80,
		["Attack no ally"] = 25,
		["Auto Cloak Popups"] = 0,
		...
		["Comblast & Dgun Range"] = 66,
		["Combo Overhead/Free Camera (experimental)"] = 0,
		CommandInsert = 98,
		["Commander Hurt Vignette"] = 101,
		...
		["Context Build"] = 87,
		Cursors = 83,
		CustomFormations2 = 106,
		["DGun Stall Assist"] = 74,
		["DGun no ally"] = 50,
		...
		["MexUpg Helper"] = 0,
		MoreSounds = 70,
		["Mouse Buildspacing"] = 102,
		["Mouse FX"] = 90,
		["Mouse Reclaim/Patrol"] = 103,
		["Mouse to Mexes"] = 0,
		["Move Window Position"] = 0,
		["Music Player"] = 18,
		NoDuplicateOrders = 75,
