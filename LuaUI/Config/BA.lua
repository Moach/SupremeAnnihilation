...
- Use mousewheel (+hold ÿÿÿSHIFTÿÿÿÿ for speedup)\
 to scroll through the chatlog.",
	...
	order = {
		...
		["Factory KickStart"] = 0,
		["Factory hold position"] = 55,
		FactoryGuard = 0,
		["FactoryQ Manager"] = 9,
		["Fancy Selected Units"] = 13,
		["First launch setup"] = 0,
		["Frontline Repairs"] = 64,
		...
		["Red Console (Battle and autohosts)"] = 57,
