...
- Use mousewheel (+hold ÿÿÿSHIFTÿÿÿÿ for speedup)\
 to scroll through the chatlog.",
	...
	order = {
		...
		["Context Build"] = 0,
		Cursors = 0,
		CustomFormations2 = 71,
		["DGun Stall Assist"] = 42,
		["DGun no ally"] = 46,
		["DGun no ground enemies"] = 37,
		["Darken map"] = 0,
		["Default Group Recall Fix"] = 70,
		["Defense Range"] = 0,
		...
		FactoryGuard = 0,
		["FactoryQ Manager"] = 9,
		["Fancy Selected Units"] = 11,
		["First launch setup"] = 0,
		["Frontline Repairs"] = 55,
		...
		["Passive builders"] = 59,
		["Pause Screen"] = 8,
		["Pause/Unpause sounds"] = 35,
		["Persistent Build Spacing"] = 27,
		["Player Color Palette"] = 7,
		["Player-TV"] = 0,
		["Point Tracker"] = 0,
		Prospector = 59,
		["Quick Unload"] = 62,
		...
		ReclaimInfo = 0,
		["Red Build/Order Menu"] = 43,
		["Red Console (Battle and autohosts)"] = 50,
		["Red Console (In-game chat only)"] = 45,
		["Red Minimap"] = 12,
		["Red Tooltip"] = 9,
		Red_Drawing = 73,
		Red_UI_Framework = 4,
		...
		["Select n Center!"] = 84,
		["Selected Units Buttons"] = 28,
		["Self-Destruct icons"] = 0,
		["Set fighters on Fly mode"] = 68,
		...
		["Spectate Selected"] = 0,
		["Spy move/reclaim defaults"] = 2,
		["State Prefs"] = 0,
		["State Remover"] = 0,
		["State Reverse Toggle"] = 29,
		["Statistics Collection"] = 0,
		["Stockpiler (dynamic)"] = 57,
		["Stop means Stop"] = 30,
		["Take Proxy"] = 31,
		TeamPlatter = 0,
		TeamStats = 0,
