...
- Use mousewheel (+hold ÿÿÿSHIFTÿÿÿÿ for speedup)\
 to scroll through the chatlog.",
	...
	order = {
		...
		["Attack AoE"] = 73,
		["Attack and Move Notification"] = 56,
		["Attack no ally"] = 23,
		["Auto Cloak Popups"] = 0,
		...
		CloseFight = 0,
		["Com DontBreakCloak"] = 52,
		["Comblast & Dgun Range"] = 60,
		...
		["DGun Stall Assist"] = 44,
		["DGun no ally"] = 50,
		["DGun no ground enemies"] = 39,
		["Darken map"] = 0,
		["Default Group Recall Fix"] = 86,
		["Defense Range"] = 0,
		...
		["Factory KickStart"] = 0,
		["Factory hold position"] = 63,
		FactoryGuard = 0,
		["FactoryQ Manager"] = 9,
		["Fancy Selected Units"] = 13,
		["First launch setup"] = 0,
		["Frontline Repairs"] = 62,
		...
		ReclaimInfo = 0,
		["Red Build/Order Menu"] = 46,
		["Red Console (Battle and autohosts)"] = 55,
		["Red Console (In-game chat only)"] = 48,
		["Red Minimap"] = 14,
		["Red Tooltip"] = 11,
		Red_Drawing = 89,
		Red_UI_Framework = 5,
