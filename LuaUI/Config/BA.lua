...
- Use mousewheel (+hold ÿÿÿSHIFTÿÿÿÿ for speedup)\
 to scroll through the chatlog.",
	...
	order = {
		...
		["Attack AoE"] = 85,
		["Attack and Move Notification"] = 77,
		["Attack no ally"] = 25,
		["Auto Cloak Popups"] = 0,
		...
		["Clever gathering point"] = 68,
		["Cloak Fire State 2"] = 20,
		CloseFight = 70,
		["Com DontBreakCloak"] = 60,
		["Comblast & Dgun Range"] = 63,
		...
		["Show Orders"] = 36,
		["Smart Area Reclaim"] = 65,
		SmartNanos = 59,
		SmartSelect = 40,
		SmoothScroll = 0,
		Snow = 0,
		["Specific Unit Loader"] = 64,
