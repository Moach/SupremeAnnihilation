...
- Use mousewheel (+hold ÿÿÿSHIFTÿÿÿÿ for speedup)\
 to scroll through the chatlog.",
	...
	order = {
		...
		["Attack AoE"] = 76,
		["Attack and Move Notification"] = 53,
		["Attack no ally"] = 26,
		["Auto Cloak Popups"] = 0,
		["Auto First Build Facing"] = 27,
		["Auto Group"] = 67,
		...
		CloseFight = 0,
		["Com DontBreakCloak"] = 51,
		["Comblast & Dgun Range"] = 56,
		...
		["Commands FX"] = 0,
		["Commands info"] = 8,
		["Constructor locater"] = 64,
		["Context Build"] = 0,
		Cursors = 78,
		CustomFormations2 = 90,
		["DGun Stall Assist"] = 49,
		["DGun no ally"] = 60,
		["DGun no ground enemies"] = 43,
		["Darken map"] = 0,
		["Default Group Recall Fix"] = 89,
		["Defense Range"] = 14,
		...
		["Factory KickStart"] = 0,
		["Factory hold position"] = 66,
		FactoryGuard = 0,
		["FactoryQ Manager"] = 10,
		["Fancy Selected Units"] = 15,
		["First launch setup"] = 12345,
		["Frontline Repairs"] = 25,
		...
		ReclaimInfo = 0,
		["Red Build/Order Menu"] = 56,
		["Red Console (Battle and autohosts)"] = 71,
		["Red Console (In-game chat only)"] = 59,
		["Red Minimap"] = 16,
		["Red Tooltip"] = 12,
		Red_Drawing = 92,
		Red_UI_Framework = 6,
