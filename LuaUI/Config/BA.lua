...
- Use mousewheel (+hold ÿÿÿSHIFTÿÿÿÿ for speedup)\
 to scroll through the chatlog.",
	...
	order = {
		...
		["Air ground area attack"] = 42,
		["Ally Selected Units"] = 0,
		AllyCursors = 0,
		["Alternate Chat Keys"] = 23,
		["Ambient Player"] = 0,
		["Anti Ranges"] = 79,
		["Anti-Comnap v1.2"] = 18,
		["Area Mex"] = 0,
		...
		["Attack AoE"] = 74,
		["Attack and Move Notification"] = 52,
		["Attack no ally"] = 24,
		["Auto Cloak Popups"] = 0,
		["Auto First Build Facing"] = 25,
		["Auto Group"] = 72,
		...
		CloseFight = 0,
		["Com DontBreakCloak"] = 49,
		["Comblast & Dgun Range"] = 55,
		...
		["Factory KickStart"] = 0,
		["Factory hold position"] = 57,
		FactoryGuard = 0,
		["FactoryQ Manager"] = 10,
		["Fancy Selected Units"] = 14,
		["First launch setup"] = 0,
		["Frontline Repairs"] = 66,
		...
		["Passive builders"] = 60,
		["Pause Screen"] = 11,
		["Pause/Unpause sounds"] = 38,
		["Persistent Build Spacing"] = 30,
		...
		ReclaimInfo = 0,
		["Red Build/Order Menu"] = 48,
		["Red Console (Battle and autohosts)"] = 59,
		["Red Console (In-game chat only)"] = 51,
		["Red Minimap"] = 15,
		["Red Tooltip"] = 12,
		Red_Drawing = 89,
		Red_UI_Framework = 6,
		...
		["Select n Center!"] = 85,
		["Selected Units Buttons"] = 31,
		["Self-Destruct icons"] = 0,
		["Set fighters on Fly mode"] = 83,
